...
import time
import sys
sys.path.append('C:/Users/shana/anaconda3/envs/dlc-live/Lib/site-packages/dlclivegui/')
...
class DLCLiveGUI(object):
    ...
    def get_config(self, cfg_name):
        ...
        self.selected_option = (self.get_config_path(cfg_name))
    ...
    def init_dlc(self):
        ...
        self.stop_pose()
        # self.change_display_keypoints()
        # self.display_keypoints.set(True)
    ...
    def createGUI(self):
        ...
        self.cfg_entry["values"] = tuple(self.cfg_list) 
        ...
        self.camera_entry["values"] = cam_names
        if cam_names:
